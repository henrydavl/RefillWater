<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="row no-gutters">
            <div class="col md-10">
                <h1 class="h4 mb-0 font-weight-bold text-primary" style="margin-top: 0.2em;">My Ticket</h1>
            </div>
            <div class="col md-2">
                <button type="button" class="btn btn-dark btn-circle float-right" title="Add New Ticket" data-toggle="modal"
                        data-target="#addmodal"><i class="fas fa-plus-circle"></i></button>
                @include('bureau.ticket.crud.create')
            </div>
        </div>
    </div>
    <div class="card-body">
                                ...
                                <div class="row no-gutters">
                                    @if($ticket->is_done == '0')
                                        <div class="col-md-6">
                                            ...
                                            @include('bureau.ticket.crud.editTicket')
                                        </div>
                                        <div class="col-md-6">
                                            <form action="{{route('my-tickets.destroy', $ticket->id)}}" method="POST">
                                                {{ csrf_field() }}
                                    ...
                                    @else
                                        <div class="col-md-12">
                                            ...
                                            @include('bureau.ticket.crud.showTicket')
                                        </div>
                                    @endif
                                </div>
                            </td>
